...
public class CitizenService {
	...
	public List<Object[]> findCitizenAndVaccinationCenterByHcName(String hcname) {
		return citizenRepository.findCitizenAndVaccinationCenterByHcName(hcname);
	}
	public List<Object[]> findCitizensAndTheirCenter(String cname) {
		return citizenRepository.findCitizensAndTheirCenter(cname);
	}
